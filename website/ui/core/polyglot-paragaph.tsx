...
export const PolyglotParagraph = ({ children, ...rest }: PolyglotParagraphProps) => {
...
const checkChildrenLead = (children: ReactNode) => {
...
const trimChildrenLead = (children: ReactNode) => {
  const arr = Children.toArray(children);
